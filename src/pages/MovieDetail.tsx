        ...
        <div className="max-w-6xl mx-auto space-y-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div className="flex items-center gap-3 px-6 py-4 bg-orange-600/10 border border-orange-600/20 rounded-3xl">
                    ...
                    <p className="text-[11px] text-orange-200 font-medium">
                        <b>Hindi Audio:</b> Select <b>HINDI (VIP)</b> or <b>HINDI (2)</b>. Inside player, check Settings for Audio.
                    </p>
                </div>
            </div>
          </section>
          ...
          <section className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <Button
                    onClick={() => window.open(`https://www.google.com/search?q=${encodeURIComponent((movie as any).title || (movie as any).name)} download hindi dubbed 1080p`, '_blank')}
